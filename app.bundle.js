/* EcoTrack bundle — GENERATED by scripts/build.js. Do not edit by hand.
...
function round(n) {
  ...
  module.exports = { CATEGORY_LABELS, createDefaultProfile, toNonNegativeNumber, annualize, calculateFootprint, rankCategories };
...
const { annualize, toNonNegativeNumber, CATEGORY_LABELS } = __require('core/calculator');
...
__def("chart", function (module, __require) {
/**
...
function round(n) {
  ...
  module.exports = { chartGeometry, lineChartSVG };
...
const { createDefaultProfile, calculateFootprint, rankCategories, toNonNegativeNumber } = __require('core/calculator');
const { benchmark, headline } = __require('core/benchmarks');
const { recommend } = __require('core/recommendations');
const { projectFootprint, autoSelectForTarget, goalStatus, goalPresets } = __require('core/planner');
const { coachingNote, goalMessage, progressMessage } = __require('core/insights');
const { formatKg, formatTonnes, formatPercent, treesEquivalent, isoDate } = __require('core/format');
const { lineChartSVG } = __require('chart');
const { BENCHMARKS } = __require('data/emissionFactors');
